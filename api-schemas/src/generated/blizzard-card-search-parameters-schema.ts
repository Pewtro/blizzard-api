...
export const BlizzardCardSearchParametersSchema = z.object({
  attack: z.union([z.any(), z.string()]).optional(),
  defaultMercenary: z.union([z.any(), z.string()]).optional(),
  health: z.union([z.any(), z.string()]).optional(),
  mercenaryId: z.union([z.any(), z.string()]).optional(),
  gameMode: z
    .union([
      z.any(),
      z.literal('arena'),
