...
test('classic-wow.realmSearch should match RealmSearchResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'classic-wow.realmSearch', err && (err as Error).message);
    throw err;
  }
});
