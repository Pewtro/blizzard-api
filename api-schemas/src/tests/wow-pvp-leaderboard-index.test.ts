...
test('wow.pvpLeaderboardIndex should match PvpLeaderboardIndexResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'wow.pvpLeaderboardIndex', err && (err as Error).message);
    throw err;
  }
});
