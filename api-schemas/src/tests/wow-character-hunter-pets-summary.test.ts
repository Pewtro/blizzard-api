...
test('wow.characterHunterPetsSummary should match CharacterHunterPetsSummaryResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'wow.characterHunterPetsSummary', err && (err as Error).message);
    throw err;
  }
});
