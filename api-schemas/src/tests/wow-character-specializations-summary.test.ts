...
test('wow.characterSpecializationsSummary should match CharacterSpecializationsSummaryResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'wow.characterSpecializationsSummary', err && (err as Error).message);
    throw err;
  }
});
