...
test('wow.playableRaceIndex should match PlayableRaceIndexResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'wow.playableRaceIndex', err && (err as Error).message);
    throw err;
  }
});
