...
test('classic-wow.itemClassIndex should match ItemClassIndexResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'classic-wow.itemClassIndex', err && (err as Error).message);
    throw err;
  }
});
