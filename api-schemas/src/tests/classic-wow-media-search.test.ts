...
test('classic-wow.mediaSearch should match MediaSearchResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'classic-wow.mediaSearch', err && (err as Error).message);
    throw err;
  }
});
