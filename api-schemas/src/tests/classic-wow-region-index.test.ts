...
test('classic-wow.regionIndex should match RegionIndexResponseSchema', async () => {
  ...
  try {
    ...
    console.warn('Skipping test for', 'classic-wow.regionIndex', err && (err as Error).message);
    throw err;
  }
});
