...
describe.concurrent('techTalentApi', () => {
  ...
  test('should return the correct path for techTalentIndex', ({ expect }) => {
    const resource = techTalentIndex();
    expect(resource.path).toBe(`${wowBasePath}/tech-talent/index`);
    expect(resource.namespace).toBe('static');
  });

  test('should return the correct path for techTalentMedia', ({ expect }) => {
  ...
  test('should return the correct path for techTalentTree', ({ expect }) => {
  ...
  test('should return the correct path for techTalentTreeIndex', ({ expect }) => {
