...
describe('mythicKeystoneDungeonApi', () => {
  it('mythicKeystoneDungeon should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystoneDungeonIndex should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystoneIndex should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystonePeriod should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystonePeriodIndex should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystoneSeason should return a resource object with the correct path and namespace', () => {
  ...
  it('mythicKeystoneSeasonIndex should return a resource object with the correct path and namespace', () => {
