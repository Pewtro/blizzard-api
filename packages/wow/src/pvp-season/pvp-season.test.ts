...
describe('pvpSeasonApi', () => {
  ...
  it('pvpLeaderboard should return a resource object with the correct path and namespace', () => {
  ...
  it('pvpLeaderboardIndex should return a resource object with the correct path and namespace', () => {
  ...
  it('pvpRewardsIndex should return a resource object with the correct path and namespace', () => {
  ...
  it('pvpSeason should return a resource object with the correct path and namespace', () => {
  ...
  it('pvpSeasonIndex should return a resource object with the correct path and namespace', () => {
