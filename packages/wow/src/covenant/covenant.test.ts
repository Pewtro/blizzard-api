...
describe.concurrent('covenantApi', () => {
  ...
  test('should return the correct path and namespace for conduitIndex', ({ expect }) => {
  ...
  test('should return the correct path and namespace for covenant', ({ expect }) => {
  ...
  test('should return the correct path and namespace for covenantIndex', ({ expect }) => {
  ...
  test('should return the correct path and namespace for covenantMedia', ({ expect }) => {
    const covenantId = 123;
  ...
  test('should return the correct path and namespace for soulbind', ({ expect }) => {
  ...
  test('should return the correct path and namespace for soulbindIndex', ({ expect }) => {
