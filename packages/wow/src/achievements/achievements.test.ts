...
describe('Achievements', () => {
  it('should return correct path and namespace for achievementCategory', () => {
  ...
  it('should return correct path and namespace for achievementCategoryIndex', () => {
  ...
  it('should return correct path and namespace for achievement', () => {
  ...
  it('should return correct path and namespace for achievementIndex', () => {
  ...
  it('should return correct path and namespace for achievementMedia', () => {
