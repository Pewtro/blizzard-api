...
describe.concurrent('modifiedCraftingApi', () => {
  ...
  test('should return the correct path for modifiedCraftingCategoryIndex', ({ expect }) => {
    const resource = modifiedCraftingCategoryIndex();
    expect(resource.path).toBe(`${wowBasePath}/modified-crafting/category/index`);
    expect(resource.namespace).toBe('static');
  });

  test('should return the correct path for modifiedCraftingIndex', ({ expect }) => {
    const resource = modifiedCraftingIndex();
    expect(resource.path).toBe(`${wowBasePath}/modified-crafting/index`);
    expect(resource.namespace).toBe('static');
  });

  test('should return the correct path for modifiedCraftingReagentSlotType', ({ expect }) => {
  ...
  test('should return the correct path for modifiedCraftingReagentSlotTypeIndex', ({ expect }) => {
