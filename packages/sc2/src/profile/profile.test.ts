...
describe('profile', () => {
  ...
  test('should generate correct path for staticProfile', () => {
  ...
  test('should generate correct path for metadata', () => {
  ...
  test('should generate correct path for ladderSummary', () => {
  ...
  test('should generate correct path for ladder', () => {
