...
describe('smoketest some wow api responses', async () => {
  ...
  it('should be able to connected realm index', async () => {
  ...
  it('should be able to fetch realm index', async () => {
  ...
  it('should be able to fetch a specific realm', async () => {
  ...
  it('should be able to fetch a specific item', async () => {
  ...
  it('can search for an azerite essence', async () => {
  ...
  it('can search for a connected realm', async () => {
  ...
  it('can search for a creature', async () => {
  ...
  it('can search for an item', async () => {
  ...
  it('can search for a journal encounter', async () => {
    const response = await client.sendRequest(
  ...
  it('can search for a regular realm', async () => {
  ...
  it('can search for a spell', async () => {
